...
import org.sensorhub.impl.database.obs.MaxAgeAutoPurgeConfig;
...
public class ProcedureObsEventDatabaseConfigForm extends GenericConfigForm implements IModuleConfigForm
{
    ...
    public Collection<IModuleProvider> getPossibleModuleTypes(String propId, Class<?> configType)
    {
        ...
        while (it.hasNext())
        {
            ...
            if (provider.getModuleConfigClass().isAssignableFrom(ProcedureObsEventDatabaseConfig.class))
                it.remove();
