...
public class TestSweApiObsWs extends TestSweApiBase
{
    ...
    public void testStreamHistoricalObsPhenomenonTimeRange() throws Exception
    {
        ...
        var path = concat(dsUrl, TestSweApiBase.OBS_COLLECTION + "?phenomenonTime=" + startTime + "/" + endTime);
    ...
    public void testStreamHistoricalObsResultTimeRange() throws Exception
    {
        ...
        var endTime = startTime.plusMillis(numStreamedObs*timeStep);
        var path = concat(dsUrl, TestSweApiBase.OBS_COLLECTION + "?resultTime=" + startTime + "/" + endTime);
        sendWsRequest(path, numStreamedObs);
    }
    ...
    public void testStreamHistoricalObsUnboundedTimeRange() throws Exception
    {
        ...
        var path = concat(dsUrl, TestSweApiBase.OBS_COLLECTION + "?phenomenonTime=../..");
    ...
    {
        return swaRootUrl.replace("http", "ws");
    }
