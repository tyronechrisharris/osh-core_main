...
public class DataStreamAddedEvent extends DataStreamEvent
{
     ...
     */
    public DataStreamAddedEvent(long timeStamp, ProcedureId procedureId, String dataStreamName, long dataStreamID)
    {
     ...
     */
    public DataStreamAddedEvent(ProcedureId procedureId, String dataStreamName, long dataStreamID)
    {
