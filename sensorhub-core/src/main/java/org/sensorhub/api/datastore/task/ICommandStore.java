...
import org.sensorhub.api.datastore.task.ICommandStore.CommandField;
import org.sensorhub.api.obs.ObsStats;
import org.sensorhub.api.tasking.ICommandDataWithAck;
...
public interface ICommandStore extends IDataStore<BigInteger, ICommandDataWithAck, CommandField, CommandFilter>
{
     ...
     */
    public Stream<ObsStats> getStatistics(CommandStatsQuery query);
