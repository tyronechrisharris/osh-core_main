...
{    
    public static final String ALL_PROCEDURES = "<#ALL>";
    
    private String procedureID = null;
    private String foiID = null;
    ...
    public static class ObsPeriodBuilder
    {
        ...
        public ObsPeriodBuilder withProcedureID(String procedureID)
        {
        ...
        public ObsPeriodBuilder withFoiID(String foiID)
        {
