 ...
 * @since 9
 */
public class FilteredSubmissionPublisher<T> implements Publisher<T>,
                                               AutoCloseable {
    /*
     ...
     * positive
     */
    public FilteredSubmissionPublisher(Executor executor, int maxBufferCapacity,
     ...
     * Flow.Subscriber#onNext(Object) onNext}.
     */
    public FilteredSubmissionPublisher() {
