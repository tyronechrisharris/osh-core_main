 ...
 * several databases instances. A given procedure can only be associated to
 ...
 * @date Sep 18, 2019
 */
public class FederatedDatabaseRegistry implements IObsDatabaseRegistry
{
    static final Logger log = LoggerFactory.getLogger(FederatedDatabaseRegistry.class);
    ...
    public FederatedDatabaseRegistry(ISensorHub hub)
    {
        this.hub = hub;
        this.obsDatabaseIDs = new TreeMap<>();
        this.obsDatabases = new TreeMap<>();
        this.procStore = new FederatedProcedureStore(this);
    ...
    {
        throw new UnsupportedOperationException("This method should not be called on the registry");
    }
}
