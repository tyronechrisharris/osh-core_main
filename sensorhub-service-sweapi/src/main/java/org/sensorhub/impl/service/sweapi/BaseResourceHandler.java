...
{
    static final String NOT_FOUND_ERROR_MSG = "Resource not found: %s";
    static final String ALREADY_EXISTS_ERROR_MSG = "Resource already exists";
    static final String ACCESS_DENIED_ERROR_MSG = "Permission denied";
    static final String INVALID_JSON_ERROR_MSG = "Invalid JSON: ";
    
    final S dataStore;
    final ResourceType<K, V> resourceType;
