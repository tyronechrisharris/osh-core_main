...
public class SWEApiSecurity extends ModuleSecurity implements RestApiSecurity
{
    ...
    public SWEApiSecurity(SWEApiService service, IObsSystemDatabase db, boolean enable)
    {
        super(service, "swapi", enable);
        this.service = Asserts.checkNotNull(service, SWEApiService.class);
