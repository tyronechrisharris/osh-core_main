...
public class TestWebsocketStreaming
{
    static Logger log = LoggerFactory.getLogger(TestWebsocketStreaming.class);
    
    TestSweApiTransactions apiTest = new TestSweApiTransactions();
    ...
    protected String preloadObs(int numObs, Instant startTime, long timeStepMillis) throws Exception
    {
     // add system
        ...
        {
            var url = apiTest.addObservation(dsUrl, startTime, timeStepMillis, i);
    ...
    public void testStreamHistoricalObsPhenomenonTimeRange() throws Exception
    {
        ...
        var path = concat(dsUrl, TestSweApiTransactions.OBS_COLLECTION + "?phenomenonTime=" + startTime + "/" + endTime);
    ...
    public void testStreamHistoricalObsResultTimeRange() throws Exception
    {
        ...
        var endTime = startTime.plusMillis(numStreamedObs*timeStep);
        var path = concat(dsUrl, TestSweApiTransactions.OBS_COLLECTION + "?resultTime=" + startTime + "/" + endTime);
        sendWsRequest(path, numStreamedObs);
    }
    ...
    public void testStreamHistoricalObsUnboundedTimeRange() throws Exception
    {
        ...
        var path = concat(dsUrl, TestSweApiTransactions.OBS_COLLECTION + "?phenomenonTime=../..");
    ...
    {
        return apiTest.swaRootUrl.replace("http", "ws");
    }
    
    
    protected String concat(String url, String path)
    {
        return apiTest.concat(url, path);
    }
