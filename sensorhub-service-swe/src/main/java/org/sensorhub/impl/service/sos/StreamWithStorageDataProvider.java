...
public class StreamWithStorageDataProvider implements ISOSDataProvider
{
    ...
    public StreamWithStorageDataProvider(IDataProducer producer, IBasicStorage storage, StreamDataProviderConfig config, final SOSDataFilter filter) throws OWSException
    {
    ...
    {
        return streamProvider.hasMultipleProducers() || storageProvider.hasMultipleProducers();
    }
    ...
    {
        return streamProvider.getProducerIDPrefix();
    }
    ...
    {
        return streamProvider.getNextProducerID();
    }
